...
import 'package:madroid_status_saver/utils/string_constant.dart';
import 'package:madroid_status_saver/view/home_screen/home_screen_widgets/status_save_dialog.dart';
        ...
        body: Padding(
          ...
          child: GridView.builder(
            ...
            itemBuilder: (context, index) => InkWell(
              onTap: () => showDialog(
                context: context,
                builder: (context) => StatusSaveDialog(),
              ),
              child: Container(
